...
const App: React.FC = () => {
  return (
    <div>
        ...
        <ul className="nav nav-tabs">
          ...
          <li className="navbar-text navbar-right logged-in-user" style={{ margin: '0.5em 1.5em' }}>
            <div>
              ...
              user@example.com <i className="fa fa-chevron-down"></i>
      ...
      <div>
        {/* SECOND AGENT: [MISSING CONTEXT] - Messages view should be dynamically inserted here */}
      </div>
      <div>
        {/* SECOND AGENT: [MISSING CONTEXT] - Contacts view should be dynamically inserted here */}
      </div>
    </div>
  );
};
